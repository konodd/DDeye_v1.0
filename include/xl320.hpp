...
void XL320::setBaudRate(int8_t id, int8_t value)
{
...
void XL320::setOperatingMode(int8_t id, int8_t value)
{
...
void XL320::setTorqueEnable(int8_t id, int8_t value)
{
...
void XL320::setLED(int8_t id, int8_t value)
{
...
void XL320::setGoalPosition(int8_t id, int16_t value)
{
...
void XL320::setGoalVelocity(int8_t id, int16_t value)
{
...
void XL320::setGoalTorque(int8_t id, int16_t value)
{
...
int XL320::getPresentPosition(int8_t id)
{
	bulkRead->clearParam();
	...
	if (dxl_addparam_result)
	{
		...
		{
			printf("receive present position from com failed!!!\n");
		}*/
		bulkRead->txRxPacket();
		return bulkRead->getData(id, ADDR_PRESENT_POSITION, LEN_PRESENT_POSITION);
	}
...
int XL320::getPresentVelocity(int8_t id)
{
	bulkRead->clearParam();
...
int XL320::getPresentLoad(int8_t id)
{
	bulkRead->clearParam();
